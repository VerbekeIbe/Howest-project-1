...
document.querySelector(".js-albumart").innerHTML = `<img class="c-album-art" src="img/albumarts/${songtitel}.png" alt="Album Art">`
document.querySelector(".js-artist").innerHTML = `<p class="c-artist">${uitvoerder}</p>`
...
const listenToVolumeInfo = function() {
  ...
  console.log("click event staat aan voor volume")
    volume_infobutton.onclick = function(){
      ...
      if (volumeinfo == true) {
        document.querySelector(".js-volume-info").innerHTML = `<div class="u-align--popup">
  ...
  console.log("click event staat aan voor trend")
    pulse_infobutton.onclick = function(){
      ...
      if (pulseinfo == true) {
        ...
        document.querySelector(".js-pulse-info").innerHTML = `<div class="u-align--popup">
...
const listenToTemperatureInfo = function() {
  ...
  console.log("click event staat aan voor trend")
    temp_infobutton.onclick = function(){
      ...
      if (trendinfo == true) {
        console.log("nu zou de info moeten verschijnen")
        document.querySelector(".js-trend-info").innerHTML = `            <div class="u-align--popup">
...
playpausebutton.onclick = function(){
  pause = !pause
  if (pause == true) {
    document.querySelector(".js-play-pause").innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24">
  ...
  console.log("socket verzonden")
    ...
    if (pause == false) {
      document.querySelector(".js-play-pause").innerHTML =     `  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
